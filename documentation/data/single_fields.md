...
The format is "NCT" followed by an 8-digit number. 

Also known as ClinicalTrials.gov Identifier
...
**Definition**: URL link based on OrgStudyId and OrgStudyIdType input in PRS, include system-generated links to NIH RePORTER, 
specifically (associated with the types of federal funding identified as OrgStudyIdType)
...
**Index Field:** designModule.designInfo.timePerspective
...
**Definition**: If "Other disclosure agreement..." 

is selected, describe the type of agreement including any provisions allowing the sponsor to require changes, ban the communication, or extend an embargo.
...
ResultsFirstSubmitDate at this point is kept empty until Results is published on the public site
