...
def test_mesh_terms_extracted_lowercase(study_key, browse_study_data):
    ...
    mesh, study_mesh, *_ = transform_conditions_browse_module(
...
def test_ancestors_extracted(study_key, browse_study_data):
    ...
    _, _, ancestors, study_ancestors, *_ = transform_conditions_browse_module(
        study_key, browse_study_data
    )
...
def test_browse_leaves_extracted(study_key, browse_study_data):
    ...
    *_, leaves, study_leaves, _, _ = transform_conditions_browse_module(
        study_key, browse_study_data
    )
...
def test_browse_branches_extracted(study_key, browse_study_data):
    ...
    *_, branches, study_branches = transform_conditions_browse_module(
        study_key, browse_study_data
    )
