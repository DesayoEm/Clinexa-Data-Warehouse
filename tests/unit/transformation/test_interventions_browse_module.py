from include.etl.transformation.core_transformation.modules.interventions_browse import transform_interventions_browse_module
...
def test_mesh_terms_extracted(study_key, browse_study_data):
    ...
    mesh, study_mesh, *_ = transform_interventions_browse_module(study_key, browse_study_data)
...
def test_ancestors_extracted(study_key, browse_study_data):
    ...
    _, _, ancestors, *_ = transform_interventions_browse_module(study_key, browse_study_data)
...
def test_browse_leaves_extracted(study_key, browse_study_data):
    ...
    *_, leaves, _, _, _ = transform_interventions_browse_module(study_key, browse_study_data)
