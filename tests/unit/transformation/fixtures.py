...
def full_study_data():
    ...
    return pd.Series({
        ...
        "protocolSection.identificationModule.secondaryIdInfos": [
            {"id": "SEC-001", "type": "OTHER", "domain": "NIH", "link": "http://study.com"},
            {"id": "SEC-002", "type": "REGISTRY", "domain": "EudraCT", "link": None},
        ],
        "protocolSection.identificationModule.nctIdAliases": ["NCT00000001", "NCT00000002"],
        ...
        # Conditions Module
        "protocolSection.conditionsModule.conditions": ["Type 2 Diabetes", "Hypertension"],
        "protocolSection.conditionsModule.keywords": ["diabetes", "blood pressure", "metabolic"],
        ...
        "protocolSection.contactsLocationsModule.locations": [
            {
                ...
                "contacts": [{"name": "Site Coordinator", "email": "coord@hospital.com"}],
            },
        ],

        # References Module
        "protocolSection.referencesModule.references": [
            {"pmid": "12345678", "type": "RESULT", "citation": "Smith J et al. 2023"},
        ],
        ...
        "protocolSection.referencesModule.availIpds": [
            {"id": "IPD001", "type": "STUDY_PROTOCOL", "url": "http://ipd.example.com", "comment": "Full protocol"},
        ],
...
def results_study_data():
    ...
    return pd.Series({
        ...
        "resultsSection.outcomeMeasuresModule.outcomeMeasures": [
            {
                ...
                "timeFrame": "12 weeks",
                "groups": [
                    {"id": "OG000", "title": "Treatment", "description": "Active arm"},
                    {"id": "OG001", "title": "Placebo", "description": "Control arm"},
                ],
                "denoms": [
                    {
                        "units": "participants",
                ...
                "classes": [
                    {
                        "categories": [
                            {
                                "measurements": [
                                    {"groupId": "OG000", "value": "-1.2", "spread": "0.8"},
                                    {"groupId": "OG001", "value": "-0.3", "spread": "0.7"},
                                ],
                            },
                        ],
                    },
        ...
        "resultsSection.participantFlowModule.groups": [
            {"id": "FG000", "title": "Treatment Arm", "description": "Active treatment"},
            {"id": "FG001", "title": "Placebo Arm", "description": "Placebo control"},
        ],
                ...
                "milestones": [
                    {
                        ...
                        "comment": None,
                        "achievements": [
                            {"groupId": "FG000", "numSubjects": "300", "comment": None},
                            {"groupId": "FG001", "numSubjects": "295", "comment": None},
                        ],
                    },
                ],
                "dropWithdraws": [
                    {
                        ...
                        "comment": None,
                        "reasons": [
                            {"groupId": "FG000", "numSubjects": "5", "comment": "Adverse event"},
                        ],
                    },
                ],
            },
        ...
        "resultsSection.adverseEventsModule.seriousEvents": [
            {
                ...
                "notes": None,
                "stats": [
                    {"groupId": "EG000", "numEvents": 2, "numAffected": 2, "numAtRisk": 250},
                ],
            },
        ],
        "resultsSection.adverseEventsModule.otherEvents": [
            {
                ...
                "stats": [
                    {"groupId": "EG000", "numEvents": 15, "numAffected": 12, "numAtRisk": 250},
                ],
            },
        ],
...
def browse_study_data():
    ...
    return pd.Series({
        ...
        "derivedSection.conditionBrowseModule.browseLeaves": [
            {"id": "M6694", "name": "Diabetes Mellitus", "asFound": "Diabetes", "relevance": "HIGH"},
        ],
        "derivedSection.conditionBrowseModule.browseBranches": [
            {"id": "BC18", "name": "Nutritional and Metabolic Diseases", "asFound": None, "relevance": "HIGH"},
        ],
        ...
        "derivedSection.interventionBrowseModule.browseLeaves": [
            {"id": "M11366", "name": "Metformin", "asFound": "Metformin", "relevance": "HIGH"},
        ],
        "derivedSection.interventionBrowseModule.browseBranches": [
            {"id": "BC19", "name": "Antidiabetic Agents", "asFound": None, "relevance": "HIGH"},
        ],
    })
